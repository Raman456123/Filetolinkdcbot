    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                return
        await m.reply_text(
            text="**👋 Hᴇʏ...!**\n\n<i>I'm Telegram Files Streaming Bot As Well Direct Links and file share link Generator</i>\n\n<i>Click On /Help To Get More Information</i>\n\n<b><i><u>Warning 🚸</u></i></b>\n\n<b>🔞 Porn Contents Leads To Permanenet Ban You.</b>",
            reply_markup=InlineKeyboardMarkup(
                [[
                ...
                [InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇꜱ", url='https://t.me/uploaddisk'),
                 InlineKeyboardButton("24/7 Movie Group", url='https://t.me/+XnCNbZ23N5wzZTQ1')]
                ]
            ),
            disable_web_page_preview=True
        )
